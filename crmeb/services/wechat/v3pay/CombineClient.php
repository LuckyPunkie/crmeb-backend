 ...
 * Class Client
 */
class CombineClient extends BaseClient
{
    ...
    public function pay($type, array $order)
    {
        $params = [
            ...
            'combine_mchid' => $this->serviceConfig->mchId,
            'combine_appid' => $this->serviceConfig->wechatAppid,
            'scene_info' => [
        ...
        foreach ($order['sub_orders'] as $sub_order) {
            $subOrder = [
                'mchid' => $this->serviceConfig->mchId,
                'amount' => [
    ...
    public function payOrderRefund(string $order_sn, array $options)
    {
        $params = [
            'sub_mchid' => $options['sub_mchid'],
            'sp_appid' => $this->serviceConfig->wechatAppid,
