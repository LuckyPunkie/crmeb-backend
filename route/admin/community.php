...
Route::group(function () {
    ...
    //社区举报/纠纷管理
    Route::group('community/report', function () {
        Route::get('list', '/list')->name('systemCommunityReportList')->option([
            '_alias' => '举报列表',
        ]);
        Route::get('detail/:id', '/detail')->name('systemCommunityReportDetail')->option([
            '_alias' => '举报详情',
        ]);
        Route::post('handle/:id', '/handle')->name('systemCommunityReportHandle')->option([
            '_alias' => '处理举报',
        ]);
    })->prefix('admin.community.CommunityReport')->option([
        '_path' => '/community/report',
        '_auth' => true,
    ]);

    //社区简历管理
    Route::group('community/resume', function () {
        Route::get('list', '/list')->name('systemCommunityResumeList')->option([
            '_alias' => '简历列表',
        ]);
        Route::get('detail/:id', '/detail')->name('systemCommunityResumeDetail')->option([
            '_alias' => '简历详情',
        ]);
        Route::get('export', '/export')->name('systemCommunityResumeExport')->option([
            '_alias' => '批量导出',
        ]);
        Route::get('option', '/positionOption')->option([
            '_alias' => '岗位选项',
            '_auth' => false,
        ]);
    })->prefix('admin.community.CommunityResume')->option([
        '_path' => '/community/resume',
        '_auth' => true,
    ]);
    ...
    Route::group('community/reply', function () {
        ...
        Route::get(':id', '/reply')->name('systemCommunityReply')->option([
            '_alias' => '内容评论列表',
        ]);
