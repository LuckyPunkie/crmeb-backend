...
Route::group(function () {
    ...
    Route::group('notice', function () {
        ...
        Route::post('update/:id', '/update')->name('systemNoticeUpdate')->option([
            '_alias' => '系统公告编辑',
        ]);
        Route::post('switchStatus/:id', '/switchStatus')->name('systemNoticeSwitchStatus')->option([
            '_alias' => '系统公告修改状态',
        ]);
        Route::get('detail/:id', '/detail')->name('systemNoticeDetail')->option([
            '_alias' => '系统公告详情',
        ]);
        Route::delete('delete/:id', '/delete')->name('systemNoticeDelete')->option([
            '_alias' => '系统公告删除',
        ]);
