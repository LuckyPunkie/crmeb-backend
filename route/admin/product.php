...
Route::group(function () {
    ...
    Route::group('store/params', function () {
        ...
        Route::delete('temp/delete/value/:id', '/deleteValue')->name('systemStoreParameterTemplateDeleteValue')
            ->option([
            '_alias' => '删除属性',
        ]);
    ...
    Route::group('store/product', function () {
        ...
        Route::post('batch_cate_hot', '/batchCateHot')->name('systemStoreProductSwitchBatchCateHot')->option([
            '_alias' => '批量设置分类推荐',
        ]);
        ...
        Route::get('get_operate_list/:product_id', '/getOperateList')->name('systemStoreProductGetOperateList')->option([
            '_alias' => '获取商品操作记录',
        ]);
        Route::get('self_lst', '/get_self_product_list')->name('systemStoreProductGetSelfProductList')->option([
            '_alias' => '获取自营商品列表',
        ]);
        Route::post('batchCopyProduct', '/batchCopyProductsToStore')->name('systemStoreProductBatchCopy')->option([
            '_alias' => '批量复制商品到店铺',
        ]);
