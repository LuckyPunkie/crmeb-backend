...
Route::group(function () {
    Route::get('check/queue', 'admin.Common/queue');
    ...
    Route::group('statistics', function () {
        ...
        Route::get('get_admin_count', '/getAdminCount')->name('systemStatisticsAdminCount')->option([
            '_alias' => '未处理业务统计',
        ]);
        Route::get('get_admin_todo', '/getAdminTodo')->name('systemStatisticsAdminTodo')->option([
            '_alias' => '待办事项',
        ]);
        Route::get('get_merchant_top', '/getMerchantTop')->name('systemStatisticsMerchantTop')->option([
            '_alias' => '商户销量排行',
        ]);
    ...
    Route::post('replace/image_host', 'admin.system.attachment.Attachment/replaceHost')->name('systemAttachmentReplaceHost')->option([
        '_alias' => '替换素材域名',
        '_path' => '/maintain/cache',
        '_auth' => true,
    ]);
    ...
    Route::get('data_screen/:key', 'admin.Common/data_screen')->name('systemDataScreen')->option([
        '_alias' => '数据大屏',
        '_auth' => true,
        '_path' => '/data-screen/index',
    ]);
    ...
    Route::group(function () {
        ...
        Route::get('info', 'admin.Common/getSystemInfo');
        ...
        Route::post('system/menu/getAdminMenusList', 'admin.system.auth.Menu/getMenusList')->append(['is_mer' => 0]);
    })->option([
        '_auth' => false,
    ]);
