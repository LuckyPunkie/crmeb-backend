...
Route::group(function () {
    ...
    // 用户表单
    Route::group('user/register', function () {
        Route::post('config', '/saveRegisterConfig')->name('systemUserRegisterConfig')->option([
            '_alias' => '保存注册配置',
            '_auth' => true,
        ]);
        Route::get('coupon', '/getRegisterCoupon')->name('systemUserRegisterCoupon')->option([
            '_alias' => '新人礼优惠券列表',
            '_auth' => true,
        ]);
    ...
    Route::group('user', function () {
        //用户列表
        Route::post('lst', '/lst')->name('systemUserLst')->option([
            '_alias' => '用户列表',
        ]);
    ...
    Route::group('user', function () {
        ...
        //清除搜索记录
        Route::get('clear_search_log', 'User/clearSearchLog')->name('systemUserClearSearchLog')->option([
            '_alias' => '清除用户搜索记录',
        ]);
        ...
        //用户列表
        Route::get('filters', 'UserSearch/filters');
        Route::get('search/:key', 'UserSearch/search');
