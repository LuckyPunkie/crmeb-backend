...
Route::group(function () {
    ...
    Route::group('upload', function () {
        Route::post('files/:field', 'Attachment/upload');
        Route::post('/video', 'Attachment/uploadVideo');
        //上传图片
        Route::post('/image/:id/:field', 'Attachment/image')->name('merchantUploadImage')
            ->option([
            '_alias' => '上传图片',
            '_path' => 'attachment',
        ]);
    })->prefix('admin.system.attachment.');

    //附件管理
    Route::group('system/attachment', function () {
        Route::post('chunk/video', '/chunkVideo');
