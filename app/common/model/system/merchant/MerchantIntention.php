...
class MerchantIntention extends BaseModel
{
    ...
    {
        return $this->hasMany(Circle::class, 'circle_id', 'circle_id')
            ->field('circle_id, name, circle_agent_id, commission_type, commission_rate, level, status')
            ->append(['merchant_count'], true);
    }
}
