...
use app\common\model\store\product\ProductReservation;
use app\common\model\store\product\ProductAttrValueReservation;
...
class StoreCart extends BaseModel
{
    ...
    {
        /** @var \think\db\Query|\think\model\Relation $query */
    ...
    public function reservationAttr()
    {
        return $this->hasOne(ProductAttrValueReservation::class,'attr_reservation_id','reservation_id');
    }
    ...
    public function getCheckCartProductAttr()
    {
        ...
        switch ($this->product_type)
        {
            ...
            case 1: //秒杀商品
                ...
                $count = $order_make->seckillOrderCounut($this->product->active_id, $this->product_id);
    ...
    public function searchMomDateAttr($query, $value)
    {
        /** @var \think\db\Query|\think\model\Relation $query */
        momTime($query, $value, 'create_time');
    }
}
