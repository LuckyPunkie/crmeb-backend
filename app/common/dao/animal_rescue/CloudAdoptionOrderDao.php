...
use app\common\model\animal_rescue\CloudAdoptionOrder;

/**
 * 云养订单 DAO
 * Class CloudAdoptionOrderDao
 * @package app\common\dao\animal_rescue
 */
class CloudAdoptionOrderDao extends BaseDao
{
    /**
     * @return string
     */
    ...
    {
        return CloudAdoptionOrder::class;
    }
    ...
    {
        $query = CloudAdoptionOrder::getDB();
