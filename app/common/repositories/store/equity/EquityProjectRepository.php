...
class EquityProjectRepository extends BaseRepository
{
    ...
    protected function formatCard(array $row, int $uid): array
    {
        ...
        $card = [
            ...
            'fund_my_amount' => (float)$row['total_amount'],
            'fund_my_share_ratio' => $this->formatRatio($row['share_ratio']),
            'reached_at_text' => !empty($row['reached_at']) ? date('Y-m-d', (int)$row['reached_at']) : '',
