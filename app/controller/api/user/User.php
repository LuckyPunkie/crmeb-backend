...
class User extends BaseController
{
    ...
    public function bill(UserBillRepository $billRepository)
    {
        ...
        return app('json')->success($billRepository->userList([
            'now_money' => $this->request->param('type/d', 0),
            'status' => 1,
...
//            }
    ...
    {
        [$page, $limit] = $this->getPage();
        $type = $this->request->param('type/s', 'week');
    ...
    {
        $uid = (int)$this->request->param('uid/d');
    ...
    /**
     * 积分列表
     * @param UserBillRepository $repository
     * @return \think\response\Json
     * @author wuhaotian
     * @email 442384644@qq.com
     * @date 2024/7/10
    ...
    public function services()
    {
        ...
        $is_sys = $this->request->param('is_sys/d');
    ...
    public function updateBaseInfo(UserBaseInfoValidate $validate)
    {
        ...
        $avatar = $this->request->param('avatar/s');
        if (!$nickname && !$avatar)
